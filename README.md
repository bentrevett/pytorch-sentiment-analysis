...
This repo contains tutorials covering how to do sentiment analysis using [PyTorch](https://github.com/pytorch/pytorch) 1.2 and [TorchText](https://github.com/pytorch/text) 0.4 using Python 3.7.
...
* 2 - [Upgraded Sentiment Analysis](https://github.com/bentrevett/pytorch-sentiment-analysis/blob/master/2%20-%20Upgraded%20Sentiment%20Analysis.ipynb)
    ...
    **This notebook is currently non-deterministic on GPUs using CUDNN due to
    [this](https://github.com/pytorch/pytorch/issues/18110) issue in PyTorch.** 
